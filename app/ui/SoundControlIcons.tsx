...
const SoundControlIcons = () => {
  ...
  return (
    <div className='relative'>
      <div className='absolute bottom-2 xl:bottom-5 right-0 pt-3 xl:pt-5 flex flex-row justify-end  z-[10000000000000000] 2xl:scale-100 md:scale-75 scale-50 origin-bottom-right'>
