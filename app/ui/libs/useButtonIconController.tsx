...
import { BLACK, BLUE_DARK, RED, RED_DARK, RED_DULL, TEAL, UI_DURATION_TIME } from '@/app/libs/UIConstants'
  ...
  useEffect(() => {
    ...
    if (svg) {
      ...
      if (isActive) {
        ...
        gsap.to(pathBGStroke, { attr: { 'fill-opacity': 1 }, duration: 0.5, ease: 'power1.out' })
      }
    }
