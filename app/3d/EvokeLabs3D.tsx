                      ...
                      >
                        <Draggable>
                          <div onPointerDown={handleMouseDown} onPointerUp={handleMouseUp}>
                            <div className='max-w-[23em] sm:max-w-[28em] md:max-w-[37em] lg:max-w-[42em] 2xl:max-w-[73em]'>
                            ...
                            {isPreLoaderFinished && (
                              <div className='scale-50 sm:scale-[60%] md:scale-[80%] lg:scale-90 2xl:scale-100 2xl:w-full origin-top-left min-w-[50em]  2xl:min-w-[0%]'>
