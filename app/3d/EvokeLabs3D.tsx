                      ...
                      >
                        <Draggable>
                          <div onPointerDown={handleMouseDown} onPointerUp={handleMouseUp}>
                            <div className='max-w-[26em] sm:max-w-[30em] md:max-w-[38.5em] lg:max-w-[43.5em] 2xl:max-w-[73em]'>
                            ...
                            {isPreLoaderFinished && (
                              <div className='left-1 relative scale-[54%] sm:scale-[62%] md:scale-[80%] lg:scale-90 2xl:scale-100 2xl:w-full origin-top-left min-w-[50em] 2xl:min-w-[0%]'>
