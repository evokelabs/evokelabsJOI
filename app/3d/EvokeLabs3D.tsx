    ...
    <>
      ...
      >
        ...
        <EffectComposer disableNormalPass>
          <DepthOfField target={[0.8, 1.75, 2.1]} focusDistance={0.002} focusRange={0.0035} bokehScale={3} />
          <Bloom mipmapBlur radius={0.65} luminanceThreshold={0.95} intensity={0.525} luminanceSmoothing={0.65} levels={5} />
