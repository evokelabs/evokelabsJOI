...
export const ASPECT_RATIO_OFFSET: AspectRatioOffsetType = {
  ...
  LG: [
    ...
    { min: 0.7, max: 0.95, offset: -0.05 },
    { min: 0.95, max: 1.1, offset: 0.1 },
    { min: 1.1, max: 1.2, offset: 0.05 },
  ...
  '3XL': [
    { min: 0, max: 0.25, offset: -0.5 },
    { min: 0.25, max: 0.27, offset: -0.3 },
    { min: 0.27, max: 0.3, offset: -0.23 },
    { min: 0.3, max: 0.7, offset: -0.4 },
