...
import { audioContext } from '@/app/audio/audioMaster'
...
const DEFAULT_MUSIC_LOOP_VOLUME = 0.5
const LOW_MUSIC_LOOP_VOLUME = 0.3
const JOI_MUSIC_LOOP_TRANSITION_DURATION = 0.5

export const useJOIVoice = ({ model, muteJOI }: { model: THREE.Object3D | null; muteJOI: boolean }) => {
